...
public class ConfirmMallCompleteTransactionResponse implements Serializable {
    ...
    public ConfirmMallCompleteTransactionResponse() {
    }

    public ConfirmMallCompleteTransactionResponse(Integer buy_order, Integer session_id,
    ...
    public String toString() {
        return "ConfirmMallCompleteTransactionResponse{" +
                "buy_order=" + buy_order +
