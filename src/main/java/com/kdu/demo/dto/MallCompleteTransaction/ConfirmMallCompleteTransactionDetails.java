...
public class ConfirmMallCompleteTransactionDetails implements Serializable {
    ...
    public ConfirmMallCompleteTransactionDetails() {
    }

    public ConfirmMallCompleteTransactionDetails(Integer amount, String status, String authorization_code,
                                                 String payment_type_code, Integer response_code,
                                                 Integer installments_number, Integer installments_amount,
                                                 String commerce_code, String buy_order) {
        this.amount = amount;
        this.status = status;
    ...
    public String toString() {
        return "ConfirmMallCompleteTransactionDetails{" +
                "amount=" + amount +
                ", status='" + status + '\'' +
