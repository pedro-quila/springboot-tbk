...
public class InitMallTransactionDetails implements Serializable {

    private Integer amount;
    private String commerce_code;
    private String buy_order;

    public InitMallTransactionDetails() {
    }

    public InitMallTransactionDetails(Integer amount, String commerce_code, String buy_order) {
        this.amount = amount;
