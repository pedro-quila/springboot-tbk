...
public class ConfirmCompleteTransactionResponse implements Serializable {
    ...
    public ConfirmCompleteTransactionResponse() {
    }

    public ConfirmCompleteTransactionResponse(Integer vci, Integer amount, String status, String buy_order,
    ...
    public String toString() {
        return "ConfirmCompleteTransactionResponse{" +
                "vci=" + vci +
                ", amount=" + amount +
                ", status='" + status + '\'' +
                ", buy_order='" + buy_order + '\'' +
