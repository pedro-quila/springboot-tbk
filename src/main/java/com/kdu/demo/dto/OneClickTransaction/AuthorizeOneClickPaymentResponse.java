...
public class AuthorizeOneClickPaymentResponse implements Serializable {
    ...
    public AuthorizeOneClickPaymentResponse() {
    }

    public AuthorizeOneClickPaymentResponse(Integer vci, Integer amount, String status, String buy_order, Integer session_id,
                                            CardDetailOneClickTransaction card_detail, Date accounting_date,
                                            Date transaction_date, String authorization_code, String payment_type_code,
                                            Integer response_code, String installments_number) {
        this.vci = vci;
        this.amount = amount;
        this.status = status;
