...
public class AuthorizeOneClickMulticodeResponse implements Serializable {
    ...
    public AuthorizeOneClickMulticodeResponse() {
    }

    public AuthorizeOneClickMulticodeResponse(Integer buy_order, Integer session_id,
    ...
    public String toString() {
        return "AuthorizeOneClickMulticodeResponse{" +
                "buy_order=" + buy_order +
